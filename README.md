...
Проекта е базиран на реален процес във фабрика за пластмасови изделия. Ползват се реални данни и реална бизнес логика и част от процеса за качествен контрол. 
