...
Проекта е базиран на реален процес във фабрика за пластмасови изделия. Ползват се реални данни и реална бизнес логика и е част от процеса за качествен контрол. 
